...
const Player = ({ onClose }: any) => {
    ...
    const { getCurrentSong, getPlaying, getSongs, setPlaying, nextSong, setFavorite, removeFavorite, getFavoriteID, setRecent } = useContext(Context);
        ...
        {!songs ? null :
            <div className="player--container">
                ...
                <div className="player--container__controls">
                    ...
                    <button className="player--container__playBtn player--console__btnStyle player--container__ctrlPositon" onClick={() => {setPlaying(!getPlaying())}}>
