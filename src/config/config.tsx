export const applicatonConfiguration = {
    ...
    menu : [ 
        ...
        { logo: require('../assets/icons/Navigation-icons/Yours Favorite.png'), title: 'Yours Favorite' }, 
        { logo: require('../assets/icons/Navigation-icons/Recently Played.png'), title: 'Recently Played' }
    ]
}
